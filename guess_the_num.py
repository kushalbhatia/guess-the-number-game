...
if guess == secretNumber:
    print(f'Good job, {name}! You guessed my number in {str(guessesTaken)} guesses.') # the variable guessesTaken is an int, so you need to add str() to concatenate to rest of string
else:
